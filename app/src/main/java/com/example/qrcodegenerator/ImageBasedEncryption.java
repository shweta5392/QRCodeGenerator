...
public class ImageBasedEncryption extends AppCompatActivity {
    // initialize variable
    ImageView image;
    TextView text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_based_encryption);
        // assign variable
        ...
        btn_encrypt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(ImageBasedEncryption.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
                    // when permission is not granted, request permission
                    ActivityCompat.requestPermissions(ImageBasedEncryption.this,
